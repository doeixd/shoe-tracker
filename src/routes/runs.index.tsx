...
function Runs() {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-gray-50 via-white to-blue-50/30 pb-safe">
      <div className="max-w-7xl mx-auto p-2 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
        {/* Header */}
        <motion.div
        ...
        >
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Runs</h1>
            <p className="text-lg text-gray-600">
              Track your running history and performance
            </p>
          </div>
          <Button
            onClick={() => {
